...
import { FileText, Download, Plus, Activity, AlertTriangle, CheckCircle, Clock, Target, BarChart3 } from 'lucide-react';
...
const ReportsPage = () => {
  ...
  const [newReport, setNewReport] = useState({ type: '', target: '', description: '' });
  const [markdownContent, setMarkdownContent] = useState(`# Título do Relatório
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">{dashboardStats.active_scans} ativos</p>
                  </CardContent>
                </Card>
                      ...
                      <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">Alvo: {activity.target}</p>
                          </div>
                        </div>
                  ...
                  <div key={report.id} className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{report.type} - {report.target}</p>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Badge variant="outline">{report.findings_count} achados</Badge>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 h-96">
                ...
                <div className="space-y-2">
                  ...
                  <div className="h-full p-4 border rounded-md bg-muted/50 overflow-auto">
                    <ReactMarkdown className="prose prose-sm max-w-none">{markdownContent}</ReactMarkdown>
                  </div>
                </div>
              </div>
            </CardContent>
